...
export function ProjectCard({ project, index = 0, variant = "grid" }: ProjectCardProps) {
  return (
    <motion.div
      ...
      className={cn(variant === "slider" && "flex-shrink-0  w-80 md:w-96", "group")}
    >
      <div className={cn(
        "relative h-full rounded-2xl border border-white/[0.06] overflow-hidden transition-all duration-400",
        ...
        <div className="relative h-44 overflow-hidden">
          <Image
            ...
            className="object-cover object-top origin-top transition-transform duration-700 group-hover:scale-105"
          />
        </div>

        {/* Gradient overlay — placed outside scaling container to prevent subpixel flicker */}
        <div className="absolute -inset-x-px -top-px h-[180px] bg-gradient-to-t from-[rgb(14,18,22)] via-[rgb(14,18,22)]/50 to-transparent pointer-events-none z-10" />
        ...
        <div className="p-5">
          <div className="flex items-start justify-between gap-3 mb-2">
            ...
            <div className="flex gap-1.5 flex-shrink-0 mt-0.5 relative z-20">
              {project.github && (
                <a
                  href={project.github}
                  target="_blank"
