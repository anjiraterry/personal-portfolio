...
import { Search, Clock, ArrowUpRight, Plus, PenTool } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              <span
                className="inline-flex items-center gap-2 mb-4 text-xs font-semibold tracking-[0.15em] uppercase"
